...
class CreateMstTaxGroupIncludedTaxesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mst__tax__group__included__taxes', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('mst__tax__group__included__taxes');
    }
}
