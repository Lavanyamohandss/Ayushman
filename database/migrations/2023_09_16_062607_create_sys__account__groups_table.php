...
class CreateSysAccountGroupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sys__account__groups', function (Blueprint $table) {
            $table->id();
            $table->string('account_group_name',100);
    ...
    {
        Schema::dropIfExists('sys__account__groups');
    }
}
