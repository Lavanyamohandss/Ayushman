                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <label class="custom-switch">
                              ...
                              <input type="checkbox" id="is_active" name="is_active" value="1" onchange="toggleStatus(this)" class="custom-switch-input" {{ isset($manufacturer->is_active) && $manufacturer->is_active == 1 ? 'checked' : '' }}>
                              <span id="statusLabel" class="custom-switch-indicator"></span>
                              <span id="statusText" class="custom-switch-description">
                                 {{ isset($manufacturer->is_active) && $manufacturer->is_active ? 'Active' : 'Inactive' }}
                              </span>
                           </label>
                        </div>
                     </div>
