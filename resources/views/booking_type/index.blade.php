    ...
    <div class="col-md-12 col-lg-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Filter Consultation Bookings</h3>
            </div>
            <form action="">
                <div class="card-body">
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4 d-flex align-items-center">
                            <div>
                                ...
                                <a class="btn btn-secondary ml-2" href="{{ route('booking_type.index') }}"><i class="fa fa-times" aria-hidden="true"></i> Cancel</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-secondary" href="{{ route('booking_type.show',$booking->id) }}">
